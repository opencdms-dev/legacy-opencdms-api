...
from datagen.climsoft import instrumentfaultreport as climsoft_instrument_fault_report, station as climsoft_station, instrument as climsoft_instrument
...
def setup_module(module):
    ...
    for i in range(1, 11):
        ...
        db_session.add(climsoft_models.Instrumentfaultreport(
            **climsoft_instrument_fault_report.get_valid_instrument_fault_report_input(station_id=station.stationId, instrument_id=instrument.instrumentId).dict()
        ))
        db_session.commit()
    db_session.close()
