...
from src.apps.climsoft.schemas import stationqualifier_schema
from tests.datagen.climsoft import stationqualifier as climsoft_station_qualifier, station as climsoft_station
